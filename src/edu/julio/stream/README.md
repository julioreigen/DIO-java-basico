...
#### README copiado do repo: [DIO - Ganhando produtividade Stream API](https://github.com/digitalinnovationone/ganhando_produtividade_com_Stream_API_Java/tree/master)
